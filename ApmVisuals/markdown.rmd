...
This is an R Markdown document for the ApmVisuals package, which uses **ggplot2** to create custom visualizations for Agile Portfolio managers. These visuals were derived from guidance from the [Scaled Agile Framework (SAFe) site](http://www.scaledagileframework.com).

These visualizations include:
* Epic Burn-Up Chart
* WSJF Comparison Chart
* Investment Opportunit Schedule
